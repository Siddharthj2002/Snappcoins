...
const Header = () => {
	...
	return (
		<header className="header_in clearfix element_to_stick">
            ...
            <img src="https://distil.in/demo/snappcoins/img/logo-light-mode.svg" alt="" width="170" height="35" className="light"/>
							</a>
						</div>
									...
									<div className="dropdown-menu dropdown-menu-end animate fadeIn">
										<div className="dropdown-menu-content">
											...
											<ul>
												...
												<li><Link  to="/profile"><i className="bi bi-pen"></i>Edit profile</Link></li>
												<li><Link  to="#"><i className="bi bi-gear"></i>Account</Link></li>
												<li><Link  to="/"><i className="bi bi-image"></i>Dashboard</Link></li>
							...
							<div id="header_menu">
								...
								<a href="/" className="logo_menu">
									...
									<ul>
										...
										<li className="submenu"><a href="catalog.html" className="show-submenu">Explore</a></li>
									</ul>
								</nav>
							</div>}
						</header>
