                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div id="newsletter">
                        ...
                        <div className="follow_us">
                            <ul>
                                <li><Link to="#0"><img src="img/twitter_icon.svg" alt="" className="lazy"/></Link></li>
                                <li><Link to="#0"><img src="img/facebook_icon.svg" alt="" className="lazy"/></Link></li>
                                <li><Link to="#0"><img src="img/instagram_icon.svg" alt="" className="lazy"/></Link></li>
                                <li><Link to="#0"><img src="img/youtube_icon.svg" alt="" className="lazy" /></Link></li>
                            </ul>
                        </div>
