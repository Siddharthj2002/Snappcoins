...
export default function Recommended(props) {
  ...
  return (
    <div className="strip" style={{ padding: '0px', margin: '0px' }}>
        ...
        <ModalBody>
          <form method="POST">
            <div className="modal-body">
              <p style={{ color: 'black' }}>
                You are about to purchase <b>{props.title}</b> <b>#304</b> from <b>George Lucas</b>
              </p>
              <p>
                <b style={{ margin: '0px', color: 'black', paddingLeft: '16px' }}>Redeem with</b>
              </p>
              <input
                type="text"
                className="form-control"
                placeholder="3.5 snapps"
                style={{ width: '100%', color: 'black', marginTop: '-20px', marginBottom: '1rem' }}
                value={`${props.price}`}
              />
            ...
            <div className="modal-footer justify-content-center">
              <Link to="/details-page" state={{ displayData, imageSrc }} style={{ width: '100%' }}>
                <button
                  type="button"
                  className="btn"
                  style={{ width: '100%', background: '#ff0071', color: 'white' }}
                >
                  Snap It!
                </button>
              </Link>
      ...
      <figure>
        <a href="#modal-dialog" className="btn_1 modal_popup" onClick={toggleModal}>
          Snapp Now!
        </a>
        {!imageLoaded && (
          <div>
