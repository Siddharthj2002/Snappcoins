  ...
  return (
    <div className="edit-profile" style={{ background: 'black' }}>
      {loading ? (
        ...
        >
          <h5 className="card-title" style={{ textAlign: 'center', marginBottom: '2rem', color: 'white' }}>
            Gamer Profile
          </h5>
...
>
  ...
  />
          ...
          <div className="form-group text-center" style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', marginLeft: '1rem' }}>
  <label htmlFor="name" style={{ color: 'gray', marginRight: '0.5rem', width: '100px' }}>
    User Name
  </label>
...
<div className="form-group text-center" style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', marginLeft: '1rem' }}>
  <label htmlFor="password" style={{ color: 'gray', marginRight: '0.5rem', width: '100px' }}>
    Password
  </label>
  <div className="d-inline-block">
    <input
...
<div className="form-group text-center" style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', marginLeft: '1rem' }}>
  <label htmlFor="email" style={{ color: 'gray', marginRight: '0.5rem', width: '100px' }}>
    Email
  </label>
  <div className="d-inline-block">
    <input
