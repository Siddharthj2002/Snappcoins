        ...
        return (
          ...
          (!(m("body").width() < i.minWidth) &&
            ((function (y, i) {
              (y.initialized = !0),
                0 ===
                  m("#theia-sticky-sidebar-stylesheet-" + y.namespace).length &&
                  m("head").append(
                    m(
                      ...
                      if (m("body").width() < i.options.minWidth) g();
                        ...
                        if (
                          ...
                          i.sidebar.offset().top +
                            (i.paddingTop - i.options.additionalMarginTop)
                        ) {
                          var o,
                            s = i.paddingTop + y.additionalMarginTop,
                            n =
                              i.paddingBottom +
                              i.marginBottom +
                          ...
                          o =
                            i.stickySidebar.outerHeight() + s + n <
                            m(window).height()
                          ...
                          "fixed" == i.stickySidebar.css("position") &&
                            "modern" == i.options.sidebarBehavior &&
                            (p += h),
                            "stick-to-top" == i.options.sidebarBehavior &&
                              (p = y.additionalMarginTop),
                            "stick-to-bottom" == i.options.sidebarBehavior &&
                              (p = o - i.stickySidebar.outerHeight()),
                            (p =
                              0 < h
                                ? Math.min(p, r)
                                : Math.max(
                                    p,
                                    o - i.stickySidebar.outerHeight()
                                  )),
                            (p = Math.max(p, c)),
                            (p = Math.min(
                              p,
                              l - i.stickySidebar.outerHeight()
                            ));
                          var f =
                            i.container.height() ==
                          ...
                          e =
                            (f || p != r) &&
                            (f || p != o - i.stickySidebar.outerHeight())
                              ? t + p - i.sidebar.offset().top - i.paddingTop <=
                        ...
                        if ("fixed" == e) {
                          ...
                          i.stickySidebar.css({
                            ...
                            left:
                              ...
                              parseInt(i.sidebar.css("padding-left")) -
                              b +
                              "px",
                            top: "0px",
                          });
